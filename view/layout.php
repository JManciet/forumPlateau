...
<body>
    <div id="wrapper"> 
                ...
                <nav>
                    ...
                    <?php
                        ...
                        if(App\Session::getUser()){
                            ...
                            <a href="index.php?ctrl=forum&action=paginationTopics&page=1">Voir la liste des topics</a>
                            <?php
                        }
                        else{
                            ?>
        ...
        <footer>
            <p>&copy; 2020 - Forum CDA - <a href="index.php?ctrl=home&action=forumRules">Règlement du forum</a> - <a href="">Mentions légales</a></p>
